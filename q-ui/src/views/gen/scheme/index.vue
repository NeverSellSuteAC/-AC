    ...
    <basic-container>
        ...
        <el-form :inline="true" :model="searchForm" ref="searchForm">
          ...
          <el-form-item label="功能作者" prop="functionAuthor">
            <el-input
              class="filter-item input-normal"
              size="small"
              v-model="searchForm.functionAuthor"
            ></el-input>
          </el-form-item>
          <el-form-item>
            <el-button
      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        <el-form :model="form" label-width="120px" ref="form">
          ...
          <el-form-item :rules="[{required: true,message: '请选择模块分类'}]" label="模块分类" prop="category">
          ...
          <el-form-item :rules="[{required: true,message: '请选择业务表名'}]" label="业务表名" prop="tableId">
            <CrudSelect :dic="tableList" v-model="form.tableId"></CrudSelect>
          </el-form-item>
          <el-form-item label="生成选项">
            <el-switch active-text="是否生成代码" v-model="form.genCode"></el-switch>
            <el-switch active-text="是否替换现有文件" v-model="form.replaceFile"></el-switch>
          </el-form-item>
      ...
      <el-dialog :visible.sync="dialogGenCodeVisible" title="系统提示" width="30%">
        <span>确认要继续操作吗?</span>
      ...
      <el-dialog :visible.sync="dialogMenuVisible" title="选择菜单">
        <el-input placeholder="输入关键字进行过滤" v-model="filterFormText"></el-input>
        <el-tree
          :data="treeMenuData"
      ...
      <el-dialog :visible.sync="dialogGenMenuVisible" title="生成菜单" width="30%">
        <el-form :model="genMenuForm" label-width="100px" ref="genMenuForm">
          ...
          >
            <el-input
              ...
              placeholder="选择菜单"
              readonly
              v-model="genMenuForm.parentMenuName"
            ></el-input>
      ...
      <el-dialog :visible.sync="dialogCodePreviewVisible" title="代码预览" width="90%">
        <el-tabs>
...
<script>
    ...
    export default {
        ...
        methods: {
            getList() {
                ...
                this.listQuery.queryConditionJson = util.parseJsonItemForm([
                    ...
                    },
                    {
                        ...
                        value: this.searchForm.functionAuthor
                    }
                ]);
            ...
            handleGenMenu() {
                if (
                    validate.checkNull(this.currentRow) ||
                    validate.checkNull(this.currentRow.id)
                ) {
                    this.$message({
                        message: "请选择方案",
                        type: "warning"
            ...
            handleGenCode(replaceFile) {
                ...
                schemeService
                    .genCode({id: this.currentRow.id, replaceFile: replaceFile})
                    .then(response => {
