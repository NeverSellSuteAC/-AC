      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        <el-form :model="form" label-width="100px" ref="form">
          ...
          <el-form-item
            ...
            prop="deptName"
          >
            <el-input @focus="clickSelectDept" placeholder="选择部门" readonly v-model="form.deptName"></el-input>
          ...
          <el-form-item :rules="[{validator: validatePass}]" label="密码" prop="password">
            <el-input
              :placeholder="this.dialogStatus == 'create' ? '请输入密码' : '若不修改密码，请留空'"
              type="password"
          ...
          <el-form-item
            :rules="[{ type: 'email',message: '请填写正确邮箱' },{max: 64,message: '长度在 不超过 64 个字符'}]"
            label="邮箱"
            prop="email"
          >
          ...
          <el-form-item :rules="rules_form.description" label="备注" prop="description">
        ...
        <div class="dialog-footer" slot="footer">
          ...
          <el-button
            ...
            size="small"
            type="primary"
            v-bind:disabled="enableEditButton"
          >保 存
          </el-button>
        </div>
      </el-dialog>
            ...
            return {
                ...
                validateUnique: (rule, value, callback) => {
                    validate.isUnique(
                        ...
                        value,
                        callback,
                        "/sys/user/checkByProperty?id=" + toString(this.form.id)
                    );
                },
                ...
                validatePass: (rule, value, callback) => {
                    ...
                    if (!validate.password(value)) {
                        callback(new Error("请输入正确的密码格式：4-64位数字或字母"));
                        return;
                    }
            ...
            handleEdit(row) {
                ...
                if (this.dialogStatus == "create") {
                    ...
                    userService.find(row.id).then(response => {
                        ...
                        this.editform = JSON.parse(JSON.stringify(response.data));
