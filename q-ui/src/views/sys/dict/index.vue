  ...
  <div class="app-container calendar-list-container">
    <basic-container>
      <el-row :gutter="20">
        <el-col :span="4">
          <el-card class="box-card">
            ...
            <el-input placeholder="输入关键字进行过滤" v-model="filterTreeDictText" v-show="searchTree"></el-input>
            <el-tree
              :data="treeDictData"
        ...
        <el-col :span="20">
          ...
          >
            ...
            <el-table-column align="center" label="上级字典" width="140">
            ...
            <el-table-column align="center" label="编码" width="160">
              <template slot-scope="scope">
            ...
            <el-table-column
              ...
              fixed="right"
              label="操作"
              v-if="sys_dict_edit || sys_dict_del"
              width="100"
            >
              <template slot-scope="scope">
                <el-button
      ...
      <el-dialog :visible.sync="dialogDictVisible" title="选择字典">
        <el-input placeholder="输入关键字进行过滤" v-model="filterParentTreeDictText"></el-input>
        <el-tree
          :data="treeDictSelectData"
      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        <el-form :model="form" label-width="100px" ref="form">
          <el-form-item label="所属字典" prop="parentName">
            <el-input
              :disabled="disableSelectParent"
              @focus="handleParentDictTree()"
              placeholder="选择字典"
              readonly
          ...
          <el-form-item :rules="[ {required: true,message: '请输入编码'}]" label="编码" prop="code">
          ...
          <el-form-item :rules="[{required: true,message: '请选择',trigger: 'change' }]" label="是否显示" prop="show">
    ...
    export default {
            ...
            return {
                ...
                validateUnique: (rule, value, callback) => {
                    validate.isUnique(
                        ...
                        value,
                        callback,
                        "/sys/dict/checkByProperty?id=" + util.objToStr(this.form.id)
                    );
                },
                dialogStatus: "create",
                textMap: {
        ...
        methods: {
            ...
            handleParentDictTree() {
                dictService.fetchTree({extId: this.form.id}).then(response => {
                    this.treeDictSelectData = util.parseTreeData(response.data);
                    this.dialogDictVisible = true;
                    setTimeout(() => {
                        this.$refs["selectParentDictTree"].setCurrentKey(
