  ...
  <div class="app-container calendar-list-container">
    <basic-container>
      <el-row :gutter="20">
        <el-col :span="3" style="margin-top:15px;">
          <el-card class="box-card">
            ...
            <el-input placeholder="输入关键字进行过滤" v-model="filterTreeMenuText" v-show="searchTree"></el-input>
            <el-tree
              :data="treeMenuData"
        ...
        <el-col :span="21">
          ...
          <el-table
            :data="list"
            :default-sort="{prop:'menu.sort',order:'ascending'}"
            :key="tableKey"
          ...
          >
            ...
            <el-table-column align="center" label="权限" width="190">
              <template slot-scope="scope">
      ...
      <el-dialog :visible.sync="dialogMenuVisible" title="选择菜单">
        <el-input placeholder="输入关键字进行过滤" v-model="filterParentTreeMenuText"></el-input>
        <el-tree
          :data="treeMenuSelectData"
      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
        <el-form :model="form" label-width="100px" ref="form">
          <el-form-item label="所属菜单" prop="parentName">
            <el-input
              :disabled="disableSelectMenuParent"
              @focus="handelParentMenuTree()"
              placeholder="选择菜单"
              readonly
          ...
          <el-form-item
            :rules="[{required: true,message: '请输入菜单名称'},{max: 32,message: '长度不超过 32 个字符'}]"
            label="名称"
            prop="name"
          >
          ...
          <el-form-item
            :rules="[ {validator:validateUnique},{max: 32,message: '长度不超过 32 个字符'}]"
            label="权限"
            prop="permission"
          >
          ...
          <el-form-item :rules="[{max: 64,message: '长度不超过 64 个字符'}]" label="VUE页面" prop="component">
          ...
          <!--            </el-switch>-->
          <!--          </el-form-item>-->
          <el-form-item :rules="[{max: 64,message: '长度不超过 128 个字符'}]" label="前端URL" prop="path">
          ...
          <el-form-item
            :rules="[{max: 200,message: '长度不超过 200 个字符'}]"
            label="描述"
            prop="description"
          >
            ...
            return {
                ...
                validateUnique: (rule, value, callback) => {
                    validate.isUnique(
                        ...
                        value,
                        callback,
                        "/sys/menu/checkByProperty?id=" + util.objToStr(this.form.id)
                    );
                },
                dialogStatus: "create",
                textMap: {
        ...
        methods: {
            getList() {
                ...
                this.listQuery.queryConditionJson = util.parseJsonItemForm([
                    ...
                    {
                        fieldName: "component",
                        value: this.searchForm.component
                    },
                    {
                        fieldName: "parent_id",
                ...
                if (this.listQuery.queryConditionJson == "[]") {
                    this.listQuery.queryConditionJson = util.parseJsonItemForm([
                        {
                            format: "",
                            fieldName: "parent_id",
            ...
            getTreeMenu() {
                menuService.fetchTree().then(response => {
                    ...
                    this.treeMenuData = util.parseTreeData([data]);
            ...
            handelParentMenuTree() {
                menuService.fetchTree({extId: this.form.id}).then(response => {
                    ...
                    data.name = "根";
                    data.label = "根";
                    data.__proto__ = response.data[0].__proto__;
                    this.treeMenuSelectData = util.parseTreeData([data]);
                    this.dialogMenuVisible = true;
                    setTimeout(() => {
                        this.$refs["selectParentMenuTree"].setCurrentKey(
            ...
            handleEditSort() {
                ...
                this.list.forEach(item => {
                    sortData.push({
                        id: item.id,
                        sort: this.$refs["sort" + item.id].value
                    });
                });
